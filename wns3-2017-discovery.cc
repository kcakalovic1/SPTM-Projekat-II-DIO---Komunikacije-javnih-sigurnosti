...
main (int argc, char *argv[])
{
  ...
  double simTime = 10;
  uint32_t nbUes = 10; // N=10 UE čvorova 
  uint16_t txProb = 100;
  ...
  // Zadavanje predajne snage UE u dBm
  ...
  // Konfiguracija modela propagacije 
  lteHelper->SetAttribute ("PathlossModel", StringValue ("ns3::FriisPropagationLossModel"));
// ns3::Cost231PropagationLossModel - promjena u testu 3
