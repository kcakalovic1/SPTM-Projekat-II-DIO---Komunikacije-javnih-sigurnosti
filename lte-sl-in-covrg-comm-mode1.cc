...
int main (int argc, char *argv[])
{
  ...
  std::cout << "Konfiguracija skupa bočnih veza ..." << "\n";
  ...
  if (!useIPv6)
    {
      ...
      std::cout << "Instaliranje IP stack-a na UE-ove i dodjela IP adresa ... " << "\n";
  ...
  std::cout<< "Poverzivanje UE na najbolji dostupni eNB čvor ... " << "\n";
  ...
  sidelinkClient.SetConstantRate (DataRate ("200kb/s"), 200);
  ...
  // omogucavanje kreiranja .tr datoteke za pracenje
  ...
  *stream->GetStream () << "time(sec)\ttx/rx\tNodeID\tIMSI\tPktSize(bytes)\tIP[src]\tIP[dst]" << std::endl;
  ...
  std::cout << "Omogućavanje Sidelink praćenja ..." << "\n";
